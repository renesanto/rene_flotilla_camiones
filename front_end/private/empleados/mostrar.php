...
<input type="hidden" name="opcion" value="3">
 ...
 <div class="col-md-7 mb-7">
    ...
    <div class="col-md-7 mb-6">
      ...
      value="<?php echo $empleado->nombre ?>" readonly>
    </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      <input type="text" class="form-control" name="apellido1" id="validationCustom02"  value="<?php echo $empleado->apellido1 ?>" readonly  >
    </div>
  </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      <input type="text" class="form-control" name="apellido2" id="validationCustom02"  value="<?php echo $empleado->apellido2 ?>" readonly >
    </div>
  </div>
  ...
  <div class="col-md-7 mb-7">
      ...
      <input type="file" class="form-control" name="foto" id="validationCustom02"  value="<?php echo $empleado->foto ?>"readonly  >
     </div>
  </div>

  <div class="col-md-3 mb-3">
  <label for="validationDefault02">Estatus</label>
      <select class="custom-select" id="estatus" name="estatus"  value="<?php echo $empleado->estatus ?>" readonly >
